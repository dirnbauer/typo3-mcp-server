...
class IntegrationTest extends FunctionalTestCase
{
    ...
    public function testBasicCrudFlowWithWorkspaceTransparency(): void
    {
        ...
        $updateData = json_decode((string)$updateResult->content[0]->text, true);
        ...
        $readAgainData = json_decode((string)$readAgainResult->content[0]->text, true);
    ...
    public function testReferenceWorkflowWithWorkspaceTransparency(): void
    {
        ...
        $pageContentData = json_decode((string)$pageContentResult->content[0]->text, true);
    ...
    public function testDeleteWithWorkspaceTransparency(): void
    {
        ...
        $deleteData = json_decode((string)$deleteResult->content[0]->text, true);
    ...
    public function testDeleteExistingLiveRecordInWorkspace(): void
    {
        ...
        $initialData = json_decode((string)$initialReadResult->content[0]->text, true);
        ...
        $readAfterDeleteData = json_decode((string)$readAfterDeleteResult->content[0]->text, true);
