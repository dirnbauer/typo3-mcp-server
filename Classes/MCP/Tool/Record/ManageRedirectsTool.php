...
final class ManageRedirectsTool extends AbstractRecordTool
{
    ...
    {
        return [
            'description' => 'Manage URL redirects (sys_redirect). '
                . 'Supports listing existing redirects with filters, creating new redirects, and deleting redirects by UID. '
    ...
    {
        $this->ensureTableAccess(self::TABLE, 'read');
