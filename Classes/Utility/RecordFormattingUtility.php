...
final class RecordFormattingUtility
{
     ...
     */
    private static function getTableCtrl(string $table): array
    {
     ...
     * @return list<mixed>
     */
    private static function getSelectItems(string $table, string $fieldName): array
    {
        $globalTca = $GLOBALS['TCA'] ?? null;
        if (!is_array($globalTca)) {
            return [];
    ...
    private static function getDefaultPageTsconfig(): string
    {
     ...
     */
    private static function getBackendLayoutForPage(int $pageId): ?array
    {
        try {
     ...
     * @return string
     */
    private static function getInheritedBackendLayout(int $parentId): string
    {
     ...
     * @return array<int, string>
     */
    private static function extractColumnsFromBackendLayout(array $rows): array
    {
        $columns = [];
     ...
     * @return array<string, mixed>
     */
    private static function parseBackendLayoutConfig(string $config): array
    {
     ...
     */
    private static function assignNestedValue(array &$result, array $pathParts, string $value): void
    {
